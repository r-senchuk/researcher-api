...
import {retrieve, reset} from '../../actions/research/show';
...
class Show extends Component {
  ...
  render() {
    ...
    return <div>
      ...
      {item && <Link to={`/researches/edit/${encodeURIComponent(item['@id'])}`}>
...
const mapStateToProps = (state) => {
  return {
    error: state.research.show.error,
    loading: state.research.show.loading,
    retrieved:state.research.show.retrieved,
