...
import { list, reset } from '../../actions/research/list';
import { success } from '../../actions/research/delete';
...
const mapStateToProps = (state) => {
  return {
    data: state.research.list.data,
    error: state.research.list.error,
    loading: state.research.list.loading,
    deletedItem: state.research.del.deleted,
  };
};
